...
const NAV = [
  ...
  ["/admin/factories", "FACTORIES"], ["/admin/freight", "FREIGHT"], ["/admin/freight/cube", "CUBE"], ["/admin/factory-ledger", "LEDGER"], ["/admin/errors", "ERRORS"], ["/admin/invites", "INVITES"], ["/admin/applications", "APPLICATIONS"],
] as const;
