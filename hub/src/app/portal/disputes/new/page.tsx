...
export default async function NewDispute() {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-5">
      ...
      <p className="text-[10px] mt-1" style={{ color: "#6E6A5E" }}>We take quality personally. Give us the picture and we&apos;ll move fast — acknowledgment within one business day.</p>
