  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-5">
      ...
      <div className="rounded-xl border overflow-hidden" style={{ background: "#fff", borderColor: "#E7DFCE" }}>
          ...
          return (
            <Link key={inv.id} href={`/portal/invoices/${inv.id}`}
              ...
              <div className="text-right">
                ...
                <p className="font-mono text-[8px] font-bold" style={{ color: STATUS_COLOR[inv.status] ?? "#6E6A5E" }}>
        ...
        {!invoices?.length && <p className="px-4 py-6 text-[11px]" style={{ color: "#6E6A5E" }}>No invoices yet.</p>}
      </div>
    </div>
  );
}
