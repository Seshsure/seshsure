...
import { runWatchdog, documentExpiry, taskEscalation, returnsProcessor, monthlyStatements, planWatchdog, freightExceptions, winBack, sampleFollowups, referralCredits, demandLetterDrafts, bidChase } from "@/lib/workers4";
...
export async function GET(req: NextRequest) {
  ...
  const jobs = [settleAndClear, applyClearedToInvoices, placeRuns, deliveryClock, expireStaleDeposits,
    ...
    planWatchdog, freightExceptions, winBack, sampleFollowups, referralCredits, demandLetterDrafts, bidChase,
