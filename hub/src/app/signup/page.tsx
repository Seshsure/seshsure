  ...
  return (
    <main className="min-h-screen" style={{ background: "#FAF5EA" }}>
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        <p className="text-[13px] mt-1" style={{ color: "#3E3A30" }}>A few steps and you&apos;re ordering. Progress saves — leave and come back anytime.</p>
        ...
        <div className="mt-6 rounded-xl border p-5" style={{ background: "#fff", borderColor: "#E7DFCE" }}>
          {loading ? <p className="text-[13px]" style={{ color: "#3E3A30" }}>Loading…</p>
            : !state ? <p className="text-[13px]" style={{ color: "#3E3A30" }}>Signup opens from your invite link. Check your email or contact rob@seshsure.com.</p>
            : state.next === "done" ? (
              <div className="text-center py-4">
                <p className="text-[15px] font-bold" style={{ color: "#0D9488" }}>✓ You&apos;re all set</p>
                <a href="/portal" className="inline-block mt-3 px-5 py-2.5 rounded-lg font-bold text-[14px]" style={{ background: "#181818", color: "#fff" }}>Enter your portal</a>
              </div>
            ) : (
              <p className="text-[14px]" style={{ color: "#181818" }}>
